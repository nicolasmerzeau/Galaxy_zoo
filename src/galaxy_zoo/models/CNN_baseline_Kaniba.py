...
def init_model(input_shape= (128,128, 3), dropout_rate: float = 0.5) -> models.Sequential:
    """
...
def init_model_custom(model_func = create_model, input_shape= (128,128, 3), dropout_rate: float = 0.5) -> models.Sequential:
    """
    Builds a deep convolutional neural network (CNN) model for binary image classification.
