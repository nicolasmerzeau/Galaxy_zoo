...
def model_wrapper(model_func, input_shape, ovr):
    ...
    Parameters:
        ...
        ovr (bool): If True, adds a Dense layer with 1 unit and sigmoid activation for binary classification.
                    If False, adds a Dense layer with units equal to input_shape[2] and softmax activation for multi-class classification.
    Returns:
    ...
    model.add(layers.Dense(input_shape[2], activation="softmax"))
